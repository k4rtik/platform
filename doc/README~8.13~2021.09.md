# Coq Platform 2022.01.0 providing Coq 8.13.2 (released Apr 2021) with an extended package pick from Sep 2021
...
This version of Coq Platform 2022.01.0 includes Coq 8.13.2 from 04/2021. There are three package picks for Coq 8.13.2: the original from 02/2021, a substantially extended one from 09/2021 and an updated one from 11/2021. This is the substantially extended and updated package pick from 09/2021. The 02/2021 and 09/2021 package picks are provided for compatibility and it is recommended to use the 11/2021 pick - or Coq 8.14.0.
...
**Note:** The package list is also available as [CSV](PackageTable~8.13~2021.09.csv).
...
(3.4.0) Iris is a Higher-Order Concurrent Separation Logic Framework with support for interactive proofs</summary>
  <dl>
    ...
    <dt><b>description</b></dt><dd>This package provides the following Coq modules:niris.prelude, iris.algebra, iris.si_logic, iris.bi, iris.proofmode, iris.base_logic, iris.program_logic.</dd>
  </dl>
</details>
...
<details>
  <summary><a href='https://github.com/ocaml-ppx/ppx_import'>ppx_import.1.9.0</a>
(1.9.0) A syntax extension for importing declarations from interface files</summary>
  <dl>
    <dt><b>authors</b></dt><dd>whitequark &lt;whitequark@whitequark.org&gt;</dd>
    <dt><b>license</b></dt><dd> <a href="https://spdx.org/licenses/MIT.html" target="_blank">MIT</a></dd>
    <dt><b>links</b></dt><dd>
      ...
      (<a href='https://opam.ocaml.org/packages/ppx_import/ppx_import.1.9.0/opam'>opam package</a>)
    </dd>
    <dt><b>description</b></dt><dd>A syntax extension for importing declarations from interface files</dd>
  </dl>
</details>
...
<details>
  <summary><a href='https://github.com/ocaml-ppx/ppxlib'>ppxlib.0.24.0</a>
(0.24.0) Standard library for ppx rewriters</summary>
  <dl>
    <dt><b>authors</b></dt><dd>Jane Street Group, LLC &lt;opensource@janestreet.com&gt;</dd>
    <dt><b>license</b></dt><dd> <a href="https://spdx.org/licenses/MIT.html" target="_blank">MIT</a></dd>
    <dt><b>links</b></dt><dd>
      ...
      (<a href='https://opam.ocaml.org/packages/ppxlib/ppxlib.0.24.0/opam'>opam package</a>)
    </dd>
